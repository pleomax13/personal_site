<template>
  <div>
    <table>
      ...
      <tr>
        <th colspan="4" class="lang">
          На русском языке
        </th>
      </tr>
      <tr
        v-for="search in report.ru"
        :key="search.title"
      >
        <td colspan="4">
          <table class="table-inset">
            <tr class="c1">
              <td class="td-wrap" colspan="4">
                {{ search.title }}
              </td>
            </tr>
            <tr>
              <td
                v-for="link in search.links"
                :key="link.link"
                class="cn number"
              >
      ...
      <tr>
        <th colspan="5" class="lang">
          На украинском языке
        </th>
      </tr>
      <tr
        v-for="search in report.ua"
        :key="search.title"
      >
        <td colspan="4">
          <table class="table-inset">
